    ...
    >
      <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2.5">
            {props.onSelect && (
              <button
                ...
                className={`w-4.5 h-4.5 rounded-md border-2 flex items-center justify-center transition-all ${props.isSelected
        ...
        <div className="flex items-start gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center border border-white/60 shadow-inner flex-shrink-0">
            <IonIcon icon={personOutline} className="text-base text-primary" />
          </div>
          <div className="flex-1 min-w-0">
            <span className="text-base font-bold text-slate-800 truncate leading-tight">
        ...
        {props.customer?.unpaid && (
          <div className="bg-white/50 rounded-xl px-3 py-2 border border-slate-200 flex justify-between items-center">
        ...
        <div className="glass-dark p-8 flex flex-col justify-start">
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <p className="text-slate-600 text-sm">Pelanggan: {props.customer?.namapelanggan}</p>
            </div>
          ...
          <div className="flex-1">
            ...
            <textarea
              ...
              className="w-full h-40 bg-white/50 border border-white/60 rounded-2xl p-4 text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all"
              value={complaintText}
