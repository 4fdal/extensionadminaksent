        ...
        <>
          ...
          <div className="absolute top-3 right-3 flex items-center gap-2 z-10">
            <button
              ...
              className="bg-red-500/90 backdrop-blur-md shadow-sm px-3 py-1.5 rounded-lg border border-red-400 text-white text-[10px] font-bold hover:bg-red-600 flex items-center gap-1.5 transition-colors"
            >
